...
namespace rst
{
    ...
    public:
        ...
        void set_diffuse_texture(Texture tex) { diffuse_texture = tex; }
		void set_bump_texture(Texture tex) { bump_texture = tex; }
    ...
    private:
        ...
        std::optional<Texture> diffuse_texture;
		std::optional<Texture> bump_texture;
