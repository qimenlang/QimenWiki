...
1.  相机原理 pin-hole 
   ...
   2. 曝光  Exposure = Time * Irradiance
      ...
      - 感光度(ISO gain):相当于后处理，对感知的光乘以一个系数
        ...
        <img src="Pictures\camera_para.png" alt="image-20210923215756794" style="zoom: 50%;" />

2. 光线追踪模拟薄棱镜

   1. 模拟在光线追踪的成像平面前放一个薄棱镜

      <img src="Pictures\camera_ray_tracing.png" style="zoom: 33%;" />

3. 景深  Depth of Field 成像清晰的一个范围

   1. 认为成像平面附近的一定范围内，成像都是锐利的；

      <img src="Pictures\DepthOfField.png" style="zoom: 33%;" />
