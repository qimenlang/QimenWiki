...
3. 质点弹簧系统
   ...
   - 初中物理
     ...
     - 弹簧质点摩擦力公式：
       ...
       <img src="Pictures\spring_drive_motion.png" style="zoom:60%;" />
     
   - 弹簧质点系统模拟布料的问题
   
     ​	<img src="Pictures\simple_springs_struct.png" style="zoom:50%;" />
   ...
   - 改进的质点弹簧系统
     ...
     <img src="Pictures\final_springs_struct.png" style="zoom:60%;" />
...
9. 物理模拟
   ...
   2. 中点法：解决欧拉方法结果偏离越来越大的问题
      ...
      <img src="Pictures\middle_point_method.png" style="zoom:60%;" />
